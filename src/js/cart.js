...
var jsContained = idList.match(regDetectJs); //ajaxLoadedData为ajax获取到的数据
                    ...
                    template += `<tr>\
                        <td class="goods-col-select">\
                            ...
                            <a href="javascript:;" class="goods-info">\
                                <h4 class="goods-info-title">${elm.title}</h4>\
                                <p class="goods-info-tips">${elm.titlex}</p>\
                            </a>\
                        </td>\
                        ...
                        <td class="goods-col-volumes">\
                            <div class="num-ctrl-area clearfix">\
                                ...
                                <input type="text" value="${arr[0].num}" class="input">\
